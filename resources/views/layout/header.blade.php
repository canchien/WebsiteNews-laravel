<div class="header">
        ...
        <div class="container">
            <div class="row row-header">
                <div class="col-xl-6 date-header">
                    <img src="frontend/img/header_icon2.png" alt=""><script> document.write(" Ngày "+new Date().getDate()+" Tháng "+new Date().getMonth()+" Năm "+new Date().getFullYear());</script>
                </div>
    ...
    <div id="navbar" style="display: flex;">
        <div class="logo">
            <a href="">
                <img src="frontend/img/your-logo.png" alt="">
            </a>
        </div>
        <ul id="navigation">
